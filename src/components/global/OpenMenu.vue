<template>
  <div class="app-card">
    ...
    >
      <v-card elevation="0">
        <v-card-title class="font-weight-black">Menu</v-card-title>
        <ul style="list-style: none">
          <li v-for="(category, i) in categories" :key="i" class="my-4 mx-3">
            <router-link
              :to="{
        ...
        <v-expansion-panels elevation="0" class="mb-6">
          <v-expansion-panel>
            ...
            <v-expansion-panel-text>
              <div
                @click="activeLang[0] = lang"
                v-for="lang in langs"
                :key="lang"
                :class="`d-flex align-center ga-2 py-3 px-1 cursor-pointer ${
                  activeLang[0].lang == lang.lang ? 'bg-grey-lighten-1' : ''
                }`"
              >
                <span
  ...
  data: () => ({
    ...
    langs: [
      ...
      },
      {
        lang: "DE",
        currency: "EURO",
        icon: `<svg xmlns="http://www.w3.org/2000/svg"  class="w-100 h-100" version="1.1" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512; width: 20px" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve">
