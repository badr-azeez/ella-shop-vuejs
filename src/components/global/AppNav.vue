<template>
  <div class="app-nav">
    ...
    >
      <v-container fluid>
        <v-row class="mt-3">
          ...
          <v-col cols="5">
            <input
              ...
              style="border-radius: 30px; width: 90%; outline: none"
              placeholder="Search The Store"
            />
          </v-col>
          <v-col cols="4" class="ps-8">
            <div
              class="parent text-white d-flex justify-space-between algin-center"
            >
              <div class="available">
              ...
              <div class="wishlists d-flex flex-column algin-center">
                <svg
                  viewBox="0 0 512 512"
                  class="icon icon-wishlist ml-2"
        ...
        C482,254.358,413.255,312.939,309.193,401.614z"
              ...
              <div
                class="wishlists d-flex flex-column algin-center pr-2"
                @click="openCart"
    ...
    <v-app-bar class="py-3" color="#111B7A" absolute>
      <v-container fluid>
        <v-row>
          <v-col cols="7">
            <ul
              class="d-flex align-center text-white justify-space-between mt-2"
          ...
          <v-col
            ...
            cols="5"
          >
            <div class="help d-flex" style="gap: 5px">
              <svg
                aria-hidden="true"
                focusable="false"
                data-prefix="fas"
            ...
            <div
              class="lang d-flex algin-center mt-2"
              id="menu-activator"
              style="gap: 5px; cursor: pointer"
            >
              <span v-html="activeLang[0].icon"></span>
              <span
                >{{ activeLang[0].lang }} / {{ activeLang[0].currency }}
              </span>
              <v-icon>mdi-chevron-down </v-icon>
              <v-menu activator="#menu-activator">
                <v-list v-model:selected="activeLang" mandatory>
                  <v-list-item
                    v-for="lang in langs"
                    :key="lang.lang"
                    :value="lang"
                    :class="
                      activeLang[0].lang == lang.lang
                        ? `bg-grey-lighten-1`
                        : `bg-white`
                    "
                  >
