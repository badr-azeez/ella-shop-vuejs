<template>
  <div class="parent py-2 pa-4">
    <v-row class="mt-1">
      ...
      <v-col cols="8">
        <ul
          class="d-flex text-white justify-center mt-2"
          ...
          <li v-for="(category, i) in categories" :key="i">
            <router-link
              :to="{
                ...
                query: { category: category.router, title: category.title },
              }"
              class="ml-3"
      ...
      <v-col cols="2" class="d-flex justify-end align-center" style="gap: 15px">
        ...
        <div
          class="card d-flex flex-column pr-2"
          @click="openCart"
