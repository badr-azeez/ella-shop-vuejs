    ...
    <div class="checkout">
      <v-row>
        <v-col class="pt-8" cols="12" md="7">
          ...
          <p class="text-center my-4 text-h6">Express Checkout</p>
          <div class="pays d-flex ga-4">
            <v-btn
              size="large"
              class="flex-grow-1 font-weight-black bg-blue-accent-4"
              ><svg
                width="81"
                height="47"
            ...
            <v-btn size="large" class="flex-grow-1 font-weight-black bg-black">
              <svg width="51" height="15" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="shipping-address my-10">
            ...
            <div class="name d-flex ga-5">
              <v-text-field label="First Name" id="id"></v-text-field>
              <v-text-field label="Last Name" id="id"></v-text-field>
            </div>
            <v-text-field label="Address" id="id"></v-text-field>
            <v-text-field label="Apartment , suite ,etc" id="id"></v-text-field>
            <div class="city d-flex ga-5">
              <v-text-field label="City" id="id"></v-text-field>
              <v-text-field label="Portal Code" id="id"></v-text-field>
            </div>
          </div>
        </v-col>
        <v-col cols="12" md="5" class="bg-blue-grey-lighten-5 px-8">
          <div class="items">
            <div
              class="item d-flex ga-6 my-6 align-center"
            ...
            >
              ...
              <router-link
                ...
                class="text-decoration-none text-blue-accent-4 flex-grow-1"
              >
                <p class="text-h6">
                  ({{ item.title }})
                  <span class="font-weight-black"
                    >Sample - {{ item.category }} For Sale</span
                  >
                </p></router-link
              >
              <span style="font-size: 19px" class="font-weight-black"
                >${{
                  (
          ...
          <div class="continue d-flex justify-end">
            <v-btn
...
import SuccessCheckOut from "@/components/dialog/SuccessCheckOut.vue";
